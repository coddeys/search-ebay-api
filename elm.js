...
var _coddeys$elm_starter_kit$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _coddeys$elm_starter_kit$Main$searchFieldView = F3(
	function (style, message, keywords) {
		return A3(
			_mdgriffith$style_elements$Element_Input$search,
			style,
			{
...
var _coddeys$elm_starter_kit$Main$modelValidator = _rtfeldman$elm_validate$Validate$all(
	{
		ctor: '::',
		_0: A2(
...
var _coddeys$elm_starter_kit$Main$validate = function (model) {
	var _p0 = model.status;
	if (_p0.ctor === 'NotAsked') {
		return _elm_lang$core$Maybe$Nothing;
	} else {
		return _elm_lang$core$List$head(
			A2(_rtfeldman$elm_validate$Validate$validate, _coddeys$elm_starter_kit$Main$modelValidator, model));
	}
};
var _coddeys$elm_starter_kit$Main$toInt = function (_p1) {
	return A2(
		_elm_lang$core$Maybe$map,
		_elm_lang$core$Basics$toString,
...
var _coddeys$elm_starter_kit$Main$currencyToString = function (currency) {
	var _p2 = currency;
	switch (_p2.ctor) {
		case 'USD':
			return 'USD';
...
var _coddeys$elm_starter_kit$Main$priceCurrencyToUrl = function (currency) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'priceCurrency:',
		_coddeys$elm_starter_kit$Main$currencyToString(currency));
};
var _coddeys$elm_starter_kit$Main$priceRangeToString = function (_p3) {
	var _p4 = _p3;
	var _p5 = {
		ctor: '_Tuple2',
		_0: _coddeys$elm_starter_kit$Main$toInt(_p4._0),
		_1: _coddeys$elm_starter_kit$Main$toInt(_p4._1)
	};
	if (_p5._0.ctor === 'Just') {
...
var _coddeys$elm_starter_kit$Main$priceRangeToUrl = F2(
	function (_p6, currency) {
		var _p7 = _p6;
		var _p8 = _coddeys$elm_starter_kit$Main$priceRangeToString(
		...
		if (_p8 === '') {
			...
			return A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					',',
					_coddeys$elm_starter_kit$Main$priceCurrencyToUrl(currency)));
		}
	});
var _coddeys$elm_starter_kit$Main$toKeywordsUrl = function (keywords) {
	return A2(
...
var _coddeys$elm_starter_kit$Main$sellerAccountTypesToString = function (sellerAccountTypes) {
	var _p9 = sellerAccountTypes;
	if (_p9.ctor === 'Individual') {
		return 'INDIVIDUAL';
	} else {
		return 'BUSINESS';
	}
};
var _coddeys$elm_starter_kit$Main$sellerAccountTypesToUrl = function (mSellerAccountType) {
	var _p10 = mSellerAccountType;
	if (_p10.ctor === 'Nothing') {
		...
		return A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				_coddeys$elm_starter_kit$Main$sellerAccountTypesToString(_p10._0),
				'}'));
	}
};
var _coddeys$elm_starter_kit$Main$toFiltersUrl_ = F4(
	function (sellerAccountType, minPrice, maxPrice, currency) {
		return A3(
			_elm_lang$core$List$foldr,
			F2(
				function (x, y) {
			...
			A2(
				...
				A2(
					...
					{
						ctor: '::',
						_0: _coddeys$elm_starter_kit$Main$sellerAccountTypesToUrl(sellerAccountType),
						_1: {
							ctor: '::',
							_0: A2(
								_coddeys$elm_starter_kit$Main$priceRangeToUrl,
								{ctor: '_Tuple2', _0: minPrice, _1: maxPrice},
								currency),
							_1: {ctor: '[]'}
						}
					})));
	});
var _coddeys$elm_starter_kit$Main$toFiltersUrl = F4(
	function (sellerAccountType, minPrice, maxPrice, currency) {
		var _p12 = A4(_coddeys$elm_starter_kit$Main$toFiltersUrl_, sellerAccountType, minPrice, maxPrice, currency);
		if (_p12 === '') {
			return '';
		} else {
			return A2(_elm_lang$core$Basics_ops['++'], '&filter=', _p12);
		}
	});
var _coddeys$elm_starter_kit$Main$generateUrl = function (model) {
	var _p13 = _elm_lang$core$String$trimLeft(model.keywords);
	if (_p13 === '') {
		return '';
	} else {
		return A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				_coddeys$elm_starter_kit$Main$toKeywordsUrl(_p13),
			...
			A2(
				...
				function (f) {
					return A2(
						...
						A2(
							_elm_lang$core$Maybe$map,
							A2(_elm_lang$core$String$slice, 1, -1),
							_elm_lang$core$List$head(
								A2(_elm_lang$core$List$drop, 1, f))));
				},
				_elm_lang$core$List$head(
					A2(
						_elm_lang$core$List$filter,
						function (f) {
							return _elm_lang$core$Native_Utils.eq(
								_elm_lang$core$List$head(f),
								_elm_lang$core$Maybe$Just('price'));
						},
						filters)))));
};
var _coddeys$elm_starter_kit$Main$priceMaxFromFilters = function (filters) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		'',
		_elm_lang$core$List$head(
				...
				A2(
					...
					A2(
						...
						A2(
							...
							_evancz$url_parser$UrlParser$stringParam('filter')),
						location)))));
};
var _coddeys$elm_starter_kit$Main$keywordsFromLoacation = function (location) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		'',
		A2(
			...
			A2(
				...
				A2(
					_evancz$url_parser$UrlParser_ops['<?>'],
					_evancz$url_parser$UrlParser$top,
					_evancz$url_parser$UrlParser$stringParam('q')),
				location)));
};
...
var _coddeys$elm_starter_kit$Main$sellerAccountTypeFromString = function (str) {
	var _p14 = str;
	switch (_p14) {
		case '{INDIVIDUAL}':
			return _elm_lang$core$Maybe$Just(_coddeys$elm_starter_kit$Main$Individual);
		case '{BUSINESS}':
			return _elm_lang$core$Maybe$Just(_coddeys$elm_starter_kit$Main$Business);
		default:
			return _elm_lang$core$Maybe$Nothing;
	}
};
var _coddeys$elm_starter_kit$Main$sellerAccountTypeFromFilters = function (filters) {
	return _coddeys$elm_starter_kit$Main$sellerAccountTypeFromString(
		A2(
			_elm_lang$core$Maybe$withDefault,
			'',
			A2(
				...
				_elm_lang$core$List$head(
					A2(
						...
						function (f) {
							return _elm_lang$core$Native_Utils.eq(
								_elm_lang$core$List$head(f),
								_elm_lang$core$Maybe$Just('sellerAccountTypes'));
						},
						filters)))));
};
var _coddeys$elm_starter_kit$Main$CAD = {ctor: 'CAD'};
var _coddeys$elm_starter_kit$Main$GBP = {ctor: 'GBP'};
var _coddeys$elm_starter_kit$Main$EUR = {ctor: 'EUR'};
var _coddeys$elm_starter_kit$Main$USD = {ctor: 'USD'};
var _coddeys$elm_starter_kit$Main$currencyFromString = function (str) {
	var _p15 = str;
	switch (_p15) {
		case 'USD':
			return _coddeys$elm_starter_kit$Main$USD;
		case 'EUR':
			return _coddeys$elm_starter_kit$Main$EUR;
		case 'GBP':
			return _coddeys$elm_starter_kit$Main$GBP;
		case 'CAD':
			return _coddeys$elm_starter_kit$Main$CAD;
		default:
			return _coddeys$elm_starter_kit$Main$USD;
	}
};
var _coddeys$elm_starter_kit$Main$currencyFromFilters = function (filters) {
	return _coddeys$elm_starter_kit$Main$currencyFromString(
		A2(
			_elm_lang$core$Maybe$withDefault,
			'',
			A2(
				...
				_elm_lang$core$List$head(
					A2(
						...
						function (f) {
							return _elm_lang$core$Native_Utils.eq(
								_elm_lang$core$List$head(f),
								_elm_lang$core$Maybe$Just('priceCurrency'));
						},
						filters)))));
};
var _coddeys$elm_starter_kit$Main$Asked = {ctor: 'Asked'};
var _coddeys$elm_starter_kit$Main$NotAsked = {ctor: 'NotAsked'};
var _coddeys$elm_starter_kit$Main$initModel = {keywords: '', sellerAccountType: _elm_lang$core$Maybe$Nothing, currency: _coddeys$elm_starter_kit$Main$USD, minPrice: '', maxPrice: '', status: _coddeys$elm_starter_kit$Main$NotAsked};
var _coddeys$elm_starter_kit$Main$init = function (location) {
	var filters = _coddeys$elm_starter_kit$Main$filtersFromLocation(location);
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		_elm_lang$core$Native_Utils.update(
			_coddeys$elm_starter_kit$Main$initModel,
			{
				keywords: _coddeys$elm_starter_kit$Main$keywordsFromLoacation(location),
				sellerAccountType: _coddeys$elm_starter_kit$Main$sellerAccountTypeFromFilters(filters),
				minPrice: _coddeys$elm_starter_kit$Main$priceMinFromFilters(filters),
				maxPrice: _coddeys$elm_starter_kit$Main$priceMaxFromFilters(filters),
				currency: _coddeys$elm_starter_kit$Main$currencyFromFilters(filters)
			}),
		{ctor: '[]'});
};
var _coddeys$elm_starter_kit$Main$update = F2(
	function (msg, model) {
		var _p16 = msg;
		switch (_p16.ctor) {
			case 'Search':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{status: _coddeys$elm_starter_kit$Main$Asked}),
					{
						ctor: '::',
						_0: _elm_lang$navigation$Navigation$newUrl(
							_coddeys$elm_starter_kit$Main$generateUrl(model)),
						_1: {ctor: '[]'}
					});
			case 'UpdKeywords':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{keywords: _p16._0, status: _coddeys$elm_starter_kit$Main$NotAsked}),
					{ctor: '[]'});
			case 'CheckSellerAccountType':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{
							sellerAccountType: _elm_lang$core$Maybe$Just(_p16._0)
						}),
					{ctor: '[]'});
			case 'CheckCurrency':
				return A2(
...
var _coddeys$elm_starter_kit$Main$UrlChange = function (a) {
	return {ctor: 'UrlChange', _0: a};
};
var _coddeys$elm_starter_kit$Main$UpdMaxPrice = function (a) {
	return {ctor: 'UpdMaxPrice', _0: a};
};
var _coddeys$elm_starter_kit$Main$UpdMinPrice = function (a) {
	return {ctor: 'UpdMinPrice', _0: a};
};
var _coddeys$elm_starter_kit$Main$CheckCurrency = function (a) {
	return {ctor: 'CheckCurrency', _0: a};
};
var _coddeys$elm_starter_kit$Main$CheckSellerAccountType = function (a) {
...
var _coddeys$elm_starter_kit$Main$searchButtonView = A3(
	...
	_coddeys$elm_starter_kit$Main$SeachButtonStyle,
	{
		...
		_1: {
			ctor: '::',
			_0: _mdgriffith$style_elements$Element_Events$onClick(_coddeys$elm_starter_kit$Main$Search),
			_1: {ctor: '[]'}
		}
	},
		...
		return {
			...
			_0: A3(
				...
				_coddeys$elm_starter_kit$Main$Clean,
				{
					...
					_1: {
						ctor: '::',
						_0: _mdgriffith$style_elements$Element_Attributes$paddingLeft(300),
						_1: {
							ctor: '::',
				...
				{
					ctor: '::',
					_0: A3(_coddeys$elm_starter_kit$Main$searchFieldView, _coddeys$elm_starter_kit$Main$SearchStyle, _coddeys$elm_starter_kit$Main$UpdKeywords, model.keywords),
					_1: {
						ctor: '::',
						_0: _coddeys$elm_starter_kit$Main$searchButtonView,
						_1: {ctor: '[]'}
					}
				}),
			_1: {
				...
				_0: A3(
					...
					{
						ctor: '::',
						_0: _mdgriffith$style_elements$Element_Attributes$paddingLeft(310),
						_1: {
							ctor: '::',
							_0: _mdgriffith$style_elements$Element_Attributes$paddingBottom(10),
							_1: {ctor: '[]'}
					...
					_mdgriffith$style_elements$Element$text(_p17._0)),
				_1: {ctor: '[]'}
			}
		};
	} else {
...
var _coddeys$elm_starter_kit$Main$view = function (model) {
	return A2(
		...
		_coddeys$elm_starter_kit$Main$stylesheet,
		A3(
			_mdgriffith$style_elements$Element$column,
			_coddeys$elm_starter_kit$Main$BodyStyle,
			{
						...
						},
						{
							...
							_0: A2(
								...
								A3(
									...
									_coddeys$elm_starter_kit$Main$Clean,
									{ctor: '[]'},
									_mdgriffith$style_elements$Element$text(' Ebay Api Search'))),
							_1: {ctor: '[]'}
						})),
				_1: {
					ctor: '::',
						...
						A3(
							...
							},
							{
								...
								_0: A3(
									...
									_coddeys$elm_starter_kit$Main$Clean,
									{ctor: '[]'},
									_coddeys$elm_starter_kit$Main$searchView(model)),
								_1: {
									ctor: '::',
									_0: A3(
										_mdgriffith$style_elements$Element$row,
											...
											_0: A3(
												...
												},
												{
													...
													_0: A3(
														...
														_coddeys$elm_starter_kit$Main$Clean,
														{ctor: '[]'},
														_mdgriffith$style_elements$Element$text('Filters')),
													_1: {
														ctor: '::',
														_0: A3(
															...
															{
																onChange: _coddeys$elm_starter_kit$Main$CheckSellerAccountType,
																selected: model.sellerAccountType,
																label: _mdgriffith$style_elements$Element_Input$labelAbove(
																	_mdgriffith$style_elements$Element$text('Seller Account Typer')),
																options: {ctor: '[]'},
																choices: {
																	ctor: '::',
																	_0: A2(
																		_mdgriffith$style_elements$Element_Input$choice,
																		_coddeys$elm_starter_kit$Main$Individual,
																		_mdgriffith$style_elements$Element$text('Individual')),
																	_1: {
																		ctor: '::',
																		_0: A2(
																			_mdgriffith$style_elements$Element_Input$choice,
																			_coddeys$elm_starter_kit$Main$Business,
																			_mdgriffith$style_elements$Element$text('Business')),
																		_1: {ctor: '[]'}
																	}
																}
															}),
														_1: {
															...
															_0: A3(
																...
																_coddeys$elm_starter_kit$Main$Clean,
																{ctor: '[]'},
																_mdgriffith$style_elements$Element$text('Price')),
															_1: {
																ctor: '::',
																_0: A3(
																	_mdgriffith$style_elements$Element$row,
																	...
																	},
																	{
																		...
																		_0: A3(
																			...
																			{
																				onChange: _coddeys$elm_starter_kit$Main$UpdMinPrice,
																		...
																		_1: {
																			...
																			_0: A3(
																				...
																				{
																					onChange: _coddeys$elm_starter_kit$Main$UpdMaxPrice,
																...
																_1: {
																	...
																	_0: A3(
																		...
																		{
																			onChange: _coddeys$elm_starter_kit$Main$CheckCurrency,
																			selected: _elm_lang$core$Maybe$Just(model.currency),
																			label: _mdgriffith$style_elements$Element_Input$labelAbove(
																				_mdgriffith$style_elements$Element$text('Currency')),
																			options: {ctor: '[]'},
																			choices: {
																				ctor: '::',
																				_0: A2(
																					_mdgriffith$style_elements$Element_Input$choice,
																					_coddeys$elm_starter_kit$Main$USD,
																					_mdgriffith$style_elements$Element$text('USD')),
																				_1: {
																					ctor: '::',
																					_0: A2(
																						_mdgriffith$style_elements$Element_Input$choice,
																						_coddeys$elm_starter_kit$Main$EUR,
																						_mdgriffith$style_elements$Element$text('EUR')),
																					_1: {
																						ctor: '::',
																						_0: A2(
																							_mdgriffith$style_elements$Element_Input$choice,
																							_coddeys$elm_starter_kit$Main$GBP,
																							_mdgriffith$style_elements$Element$text('GBP')),
																						_1: {
																							ctor: '::',
																							_0: A2(
																								_mdgriffith$style_elements$Element_Input$choice,
																								_coddeys$elm_starter_kit$Main$CAD,
																								_mdgriffith$style_elements$Element$text('CAD')),
																							_1: {ctor: '[]'}
																						}
																					}
																				}
												...
												_0: A3(
													...
													},
													{
														...
														_0: A3(
															...
															_coddeys$elm_starter_kit$Main$Clean,
															{ctor: '[]'},
															_mdgriffith$style_elements$Element$text('List of elements')),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}
...
var _coddeys$elm_starter_kit$Main$main = A2(
	_elm_lang$navigation$Navigation$program,
	_coddeys$elm_starter_kit$Main$UrlChange,
	{init: _coddeys$elm_starter_kit$Main$init, update: _coddeys$elm_starter_kit$Main$update, view: _coddeys$elm_starter_kit$Main$view, subscriptions: _coddeys$elm_starter_kit$Main$subscriptions})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _coddeys$elm_starter_kit$Main$main !== 'undefined') {
    _coddeys$elm_starter_kit$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"CheckSellerAccountType":["Main.SellerAccountType"],"CheckCurrency":["Main.Currency"],"UrlChange":["Navigation.Location"],"UpdMaxPrice":["String"],"UpdKeywords":["String"],"UpdMinPrice":["String"],"Search":[]}},"Main.Currency":{"args":[],"tags":{"USD":[],"EUR":[],"CAD":[],"GBP":[]}},"Main.SellerAccountType":{"args":[],"tags":{"Business":[],"Individual":[]}}},"aliases":{"Navigation.Location":{"args":[],"type":"{ href : String , host : String , hostname : String , protocol : String , origin : String , port_ : String , pathname : String , search : String , hash : String , username : String , password : String }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
